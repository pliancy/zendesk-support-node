...
var Zendesk = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this._zendeskRequest(this.domain + "/organizations.json", { headers: this.reqHeaders })];
                    case 1:
                        res = _a.sent();
                        return [2 /*return*/, JSON.parse(res.body)];
                    case 2:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this._zendeskRequest(this.domain + "/views.json", { headers: this.reqHeaders })];
                    case 1:
                        res = _a.sent();
                        return [2 /*return*/, JSON.parse(res.body)];
                    case 2:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this._zendeskRequest(this.domain + "/triggers.json", { headers: this.reqHeaders })];
                    case 1:
                        res = _a.sent();
                        return [2 /*return*/, JSON.parse(res.body)];
                    case 2:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this._zendeskRequest(this.domain + "/brands.json", { headers: this.reqHeaders })];
                    case 1:
                        res = _a.sent();
                        return [2 /*return*/, JSON.parse(res.body)];
                    case 2:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this._zendeskRequest(this.domain + "/recipient_addresses.json", { headers: this.reqHeaders })];
                    case 1:
                        res = _a.sent();
                        return [2 /*return*/, JSON.parse(res.body)];
                    case 2:
    ...
    Zendesk.prototype._zendeskRequest = function (url, options) {
        return __awaiter(this, void 0, void 0, function () {
            var res, err_31;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, got_1.default(url, __assign({}, options, { auth: this.config.username + ":" + this.config.password // take care of basic auth
                             }))];
                    case 1:
                        res = _a.sent();
                        return [2 /*return*/, res];
