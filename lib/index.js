            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, got_1.default(url, __assign(__assign({}, options), { username: this.config.username, password: this.config.password }))];
                    case 2:
                    ...
                    case 4: return [4 /*yield*/, got_1.default(url, __assign(__assign({}, options), { username: this.config.username, password: this.config.password }))];
                    case 5:
                        res = _a.sent();
                        _a.label = 6;
